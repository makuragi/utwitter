...
<div class="left_container">
	...
	<div class="my_profile_user">
		<ul>
			...
			<a href="./main_controller.php?action_id=profile&user_profile_id=<?php echo $login_id; ?>"><?php echo $login_user_info['user_name']; ?></a>
			</div>
			</li>
			<li>
			<div class="my_profile_user_id">
			<a href="./main_controller.php?action_id=profile&user_profile_id=<?php echo $login_id; ?>"><?php echo '@'.$login_id; ?></a>
			</div>
			</li>
		</ul>
	</div>
