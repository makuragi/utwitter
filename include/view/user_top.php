...
<div class="left_container">
	...
	<div class="my_profile_user">
		<ul>
			<li><a class="my_profile_user_name" href="./main_controller.php?action_id=profile&user_profile_id=<?php echo $login_id; ?>"><?php echo $login_user_info['user_name']; ?></a></li>
			<li><a class="my_profile_user_id" href="./main_controller.php?action_id=profile&user_profile_id=<?php echo $login_id; ?>"><?php echo '@'.$login_id; ?></a></li>
		</ul>
	</div>
